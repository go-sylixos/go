...
//go:nosplit
//go:cgo_unsafe_args
func sysconf(conf int32) int32 {
	ret := libcCall(unsafe.Pointer(abi.FuncPCABI0(sysconf_trampoline)), unsafe.Pointer(&conf))
	return ret
}
...
func malloc(size uintptr) unsafe.Pointer {
	...
	libcCall(unsafe.Pointer(abi.FuncPCABI0(malloc_trampoline)), unsafe.Pointer(&args))
	return args.ret
}
...
//go:cgo_import_dynamic libc_clock_gettime clock_gettime "libvpmpdm.so"
//go:cgo_import_dynamic libc_setitimer setitimer "libvpmpdm.so"
//go:cgo_import_dynamic libc_usleep usleep "libvpmpdm.so"
...
//go:cgo_import_dynamic libc_sigaction sigaction "libvpmpdm.so"
//go:cgo_import_dynamic libc_sigaltstack sigaltstack "libvpmpdm.so"

//go:cgo_import_dynamic libc_issetugid issetugid "libvpmpdm.so"

//go:cgo_import_dynamic libc_sysconf sysconf "libvpmpdm.so"

//go:cgo_import_dynamic libc_malloc malloc "libvpmpdm.so"

//go:cgo_import_dynamic libc_raise raise "libvpmpdm.so"
