...
TEXT runtime·pthread_attr_setdetachstate_trampoline(SB),NOSPLIT,$0
	PUSHQ	BP
	MOVQ	SP, BP
	MOVL	8(DI), SI		// arg 2 - detachstate
	MOVQ	0(DI), DI		// arg 1 - attr
...
TEXT runtime·sem_init_trampoline(SB),NOSPLIT,$0
	PUSHQ	BP
	MOVQ	SP, BP
	MOVL	8(DI), SI		// arg 2 pshared
	MOVL	16(DI), DX		// arg 3 value
	MOVQ	0(DI), DI		// arg 1 sem
...
TEXT runtime·poll_trampoline(SB),NOSPLIT,$0
	PUSHQ	BP
	MOVQ	SP, BP
	MOVQ	8(DI), SI		// arg 2 npfds
	MOVQ	16(DI), DX		// arg 3 timeout
	MOVQ	0(DI), DI		// arg 1 pfds
	CALL	libc_poll(SB)
	TESTL	AX, AX
	JGE	noerr
	CALL	libc_errno(SB)
...
TEXT runtime·API_VutexPostEx_trampoline(SB),NOSPLIT,$0
	PUSHQ	BP
	MOVQ	SP, BP
	MOVL	8(DI), SI		// arg 2 - value
	MOVL	12(DI), DX		// arg 3 - flags
	MOVQ	0(DI), DI		// arg 1 - addr
...
// and tests for 64-bit NULL(0) to decide there was an error.
TEXT runtime·syscallXnull(SB),NOSPLIT,$0
	...
	// Standard libc functions return NULL(0) on error
	// and set errno.
	CMPQ	AX, $0
	JNE	ok
