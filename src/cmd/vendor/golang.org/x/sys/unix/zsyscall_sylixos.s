// go run mkasm.go sylixos arm64
// Code generated by the script; DO NOT EDIT.
...
TEXT libc_accept4_trampoline<>(SB),NOSPLIT,$0-0
	JMP	libc_accept4(SB)
GLOBL	·libc_accept4_trampoline_addr(SB), RODATA, $8
DATA	·libc_accept4_trampoline_addr(SB)/8, $libc_accept4_trampoline<>(SB)
...
GLOBL	·libc_getentropy_trampoline_addr(SB), RODATA, $8
DATA	·libc_getentropy_trampoline_addr(SB)/8, $libc_getentropy_trampoline<>(SB)
...
TEXT libc_uname_trampoline<>(SB),NOSPLIT,$0-0
	JMP	libc_uname(SB)
GLOBL	·libc_uname_trampoline_addr(SB), RODATA, $8
DATA	·libc_uname_trampoline_addr(SB)/8, $libc_uname_trampoline<>(SB)
...
TEXT libc_posix_spawnattr_setwd_trampoline<>(SB),NOSPLIT,$0-0
	JMP	libc_posix_spawnattr_setwd(SB)
GLOBL	·libc_posix_spawnattr_setwd_trampoline_addr(SB), RODATA, $8
DATA	·libc_posix_spawnattr_setwd_trampoline_addr(SB)/8, $libc_posix_spawnattr_setwd_trampoline<>(SB)

TEXT libc_posix_spawnattr_setpgroup_trampoline<>(SB),NOSPLIT,$0-0
	JMP	libc_posix_spawnattr_setpgroup(SB)
GLOBL	·libc_posix_spawnattr_setpgroup_trampoline_addr(SB), RODATA, $8
DATA	·libc_posix_spawnattr_setpgroup_trampoline_addr(SB)/8, $libc_posix_spawnattr_setpgroup_trampoline<>(SB)
...
TEXT libc_posix_spawn_file_actions_addclose_trampoline<>(SB),NOSPLIT,$0-0
	JMP	libc_posix_spawn_file_actions_addclose(SB)
GLOBL	·libc_posix_spawn_file_actions_addclose_trampoline_addr(SB), RODATA, $8
DATA	·libc_posix_spawn_file_actions_addclose_trampoline_addr(SB)/8, $libc_posix_spawn_file_actions_addclose_trampoline<>(SB)

TEXT libc_API_IosFdGetCloExec_trampoline<>(SB),NOSPLIT,$0-0
	JMP	libc_API_IosFdGetCloExec(SB)
GLOBL	·libc_API_IosFdGetCloExec_trampoline_addr(SB), RODATA, $8
DATA	·libc_API_IosFdGetCloExec_trampoline_addr(SB)/8, $libc_API_IosFdGetCloExec_trampoline<>(SB)

TEXT libc_API_IosFdSetCloExec_trampoline<>(SB),NOSPLIT,$0-0
	JMP	libc_API_IosFdSetCloExec(SB)
GLOBL	·libc_API_IosFdSetCloExec_trampoline_addr(SB), RODATA, $8
DATA	·libc_API_IosFdSetCloExec_trampoline_addr(SB)/8, $libc_API_IosFdSetCloExec_trampoline<>(SB)
